pub struct Command {
    ...
    pub func: Box<dyn Fn(String, &crate::config::AppConfig) -> super::types::IsError>,
}

impl Command {
    pub fn new(
        name: &str,
        func: Box<dyn Fn(String, &crate::config::AppConfig) -> super::types::IsError>,
    ) -> Self {
...
pub fn hello(arg: String, app_conf: &crate::config::AppConfig) -> super::types::IsError {
    println!("hello");
    false
}
